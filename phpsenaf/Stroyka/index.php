...
<head>
    ...
    <title>Admin - TerraModa</title><!-- icon -->
            ...
            <div id="top" class="sa-app__body px-2 px-lg-4">
                <div class="container pb-6">
                        ...
                        <div class="row g-4 align-items-center">
                            <div class="col">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <span class="h4">¡Bienvenido, <?php echo $_SESSION['nombre']; ?>!</span>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <img src="images/undraw_web_shopping_re_owap.svg" height="320" alt="">
                    </div>
...
<!-- Mirrored from stroyka-admin.html.themeforest.scompiler.ru/variants/ltr/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 24 Oct 2022 00:40:32 GMT -->
