                        ...
                        <div class="py-5">
                            <div class="row g-4 align-items-center">
                                ...
                                <div class="col-auto d-flex">
                                    <a href="app-category.html" class="btn btn-primary">Nueva categoría
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="p-4"><input type="text" placeholder="Comienza a escribir para buscar categorías"
                            ...
                            <table class="sa-datatables-init" data-order="[[ 1, &quot;asc&quot; ]]"
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $fila['nombre']; $category= $fila['nombre'];?>
                                        </td>
                                        <td>
                                          <?php
                                                $resultado_category = $conexion->query("SELECT * FROM productos WHERE categoria='$category';") or die($conexion->error);
                                                $contar = mysqli_num_rows($resultado_category);
                                                echo $contar;
                                        ...
                                        <td>
                                            <div class="badge badge-sa-success">Activo</div>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <li><a href="edit-category.php?id=<?php echo $fila['id']; ?>" class="dropdown-item" name="actualizar">Editar</a></li>
                                                    <li>
                                                        <hr class="dropdown-divider" />
                                                    </li>
                                                    <li><a class="dropdown-item text-danger" href="delete-category.php?id=<?php echo $fila['id'];?>">Eliminar</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                ?>         
                                    <!-- <tr>
                                        <td><input type="checkbox" class="form-check-input m-0 fs-exact-16 d-block"
                                                aria-label="..." /></td>
                                        <td><a href="app-category.html" class="text-reset">Air Filters</a></td>
                                        <td>0</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="dropdown"><button class="btn btn-sa-muted btn-sm" type="button"
                                                    id="category-context-menu-12" data-bs-toggle="dropdown"
