                        ...
                        <div class="py-5">
                            <div class="row g-4 align-items-center">
                                <div class="col">
                                    ...
                                    <h1 class="h3 m-0">Crear categoría</h1>
                                </div>
                                <div class="col-auto d-flex">
                                    <button class="btn-primary btn " type="submit" name="enviar">Guardar</button>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" class="form-control" name="nombre" id="form-category/name" placeholder="Ingresa la nueva categoría" />
                                            </div>
