<!DOCTYPE html>
<html lang="es" dir="ltr" data-scompiler-id="0">
<?php
    session_start();
?>
                                    ...
                                    <div class="card">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" class="form-control" id="form-product/name" name="nombre" value="<?php echo $fila['nombre']; ?>" />
                                    ...
                                    <div class="card mt-5">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col">
                                                    <input type="number" class="form-control" id="form-product/price" name="precio" value="<?php $precio= $fila['precio']; $precio=preg_replace('/[^0-9]/', '', $precio ); echo $precio; ?>" />
                                                </div>
                                                <!-- <div class="col">
                                    ...
                                    <div class="card mt-5">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mb-4"><label for="form-product/sku" class="form-label">SKU</label>
                                                <input type="text" class="form-control"  name="sku" id="form-product/sku" value="<?php echo $fila['sku']; ?>" />
                                            </div>
                                            <div class="mb-4">
                                                <label>Stock</label>
                                                <div class="input-number">
                                                    <input class="form-control " type="number" name="stock" min="0" value="<?php echo $fila['disponibilidad']; ?>" >
                                                </div>
                                ...
                                <div class="sa-entity-layout__sidebar">
                                    ...
                                    <div class="card w-100 mt-4">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="mb-4">
                                                <label class="form-check">
                                                    <input type="radio" class="form-check-input" name="etiqueta"  <?php echo $fila['etiqueta']==='Nuevo' ?"checked='checked'" :""  ?> value="Nuevo" checked="" />
                                                    <span class="form-check-label">Nuevo</span>
                                                </label>
                                                <label class="form-check">
                                                    <input type="radio" class="form-check-input" name="etiqueta" <?php echo $fila['etiqueta']==='Oferta especial' ?"checked='checked'" :""  ?> value="Oferta especial" />
                                                    <span class="form-check-label">Oferta especial</span>
                                                </label>
                                                <label class="form-check">
                                                    <input type="radio" class="form-check-input" name="etiqueta" <?php echo $fila['etiqueta']==='Más vendido' ?"checked='checked'" :""  ?> value="Más vendido" />
                                    ...
                                    <div class="card w-100 mt-5">
                                        <div class="card-body p-5">
                                            ...
                                            <select class="sa-select2 form-select" name="seccion" >
                                                ...
                                                <option <?php echo $fila['seccion']==='Los más vendidos' ?"selected='selected'" :""  ?> value="Los más vendidos">Los más vendidos</option>
                                                <option <?php echo $fila['seccion']==='Ofertas especiales' ?"selected='selected'" :""  ?> value="Ofertas especiales">Ofertas especiales</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="card w-100 mt-5">
                                        <div class="card-body p-5">
                                            ...
                                            <select class="sa-select2 form-select " name="categoria">
                                                <option <?php echo $fila['categoria']==='Bicicletero' ?"selected='selected'" :""  ?> value="Bicicletero">Bicicletero</option>
                                                <option <?php echo $fila['categoria']==='Bluza' ?"selected='selected'" :""  ?>value="Blusa">Blusa</option>
                                                <option <?php echo $fila['categoria']==='Buzo' ?"selected='selected'" :""  ?> value="Buzo">Buzo</option>
                                                <option  <?php echo$fila['categoria']==='Buzo de hombre' ?"selected='selected'" :""  ?> value="Buzo de hombre">Buzo de hombre</option>
                                                <option <?php echo $fila['categoria']==='Camiseta' ?"selected='selected'" :""  ?>  value=" Camiseta">Camiseta</option>
                                                <option <?php echo $fila['categoria']==='Camiseta hombre' ?"selected='selected'" :""  ?> value="Camiseta hombre">Camiseta hombre</option>
                                                <option <?php echo $fila['categoria']==='Camisiilla' ?"selected='selected'" :""  ?> value="Camisilla">Camisilla</option>
                                                <option <?php echo $fila['categoria']==='Camisilla hombre' ?"selected='selected'" :""  ?> value="Camisilla hombre">Camisilla hombre</option>
                                                <option <?php echo $fila['categoria']==='chaqueta' ?"selected='selected'" :""  ?> value="Chaqueta">Chaqueta</option>
                                                <option <?php echo $fila['categoria']==='Chaqueta hombre' ?"selected='selected'" :""  ?> value="Chaqueta hombre">Chaqueta hombre</option>
                                                <option <?php echo $fila['categoria']==='Conjunto' ?"selected='selected'" :""  ?> value="Conjunto">Conjunto</option>
                                                <option <?php echo $fila['categoria']==='Enterizo' ?"selected='selected'" :""  ?> value="Enterizo">Enterizo</option>
                                                <option <?php echo $fila['categoria']==='Esqueleto' ?"selected='selected'" :""  ?> value="Esqueleto">Esqueleto</option>
                                                <option  <?php echo$fila['categoria']==='Falda short' ?"selected='selected'" :""  ?> value="Falda short">Falda short</option>
                                                <option <?php echo $fila['categoria']==='Jogger' ?"selected='selected'" :""  ?> value="Jogger">Jogger</option>
                                                <option <?php echo $fila['categoria']==='Leggin' ?"selected='selected'" :""  ?> value="Leggins">Leggins</option>
                                                <option <?php echo $fila['categoria']==='Licra corta hombre' ?"selected='selected'" :""  ?> value="Licra corta hombre">Licra corta hombre</option>
                                                <option <?php echo $fila['categoria']==='Pantaloneta' ?"selected='selected'" :""  ?> value="Pantaloneta">Pantaloneta</option>
                                                <option <?php echo $fila['categoria']==='Pantaloneta hombre' ?"selected='selected'" :""  ?> value="Pantaloneta hombre">Pantaloneta hombre</option>
                                                <option <?php echo $fila['categoria']==='Short' ?"selected='selected'" :""  ?> value="Short">Short</option>
                                                <option <?php echo $fila['categoria']==='Top' ?"selected='selected'" :""  ?> value="Top">Top</option>
                                                <?php
                                                $resultadoc = $conexion->query("SELECT * FROM categorias ") or die($conexion->error);

                                                 while($categoria = mysqli_fetch_array($resultadoc)) {
                                                ?>
                                                <option <?php echo $fila['categoria']===  $categoria['nombre'] ?"selected='selected'" :""  ?> value="<?php echo $categoria['nombre']; ?>"><?php echo $categoria['nombre']; ?></option>
                                                <?php
                                                 }
                                                ?> 
                                    ...
                                    <div class="card w-100 mt-5">
                                        <div class="card-body p-5">
                                            ...
                                            <select class="sa-select2 form-select" name="talla" >
                                                <option <?php echo $fila['talla']==='S' ?"selected='selected'" :""  ?> value="S">S</option>
                                                <option <?php echo $fila['talla']==='L' ?"selected='selected'" :""  ?> values="L" >L</option>
                                                <option <?php echo $fila['talla']==='M' ?"selected='selected'" :""  ?> values="M">M</option>
                                                <option <?php echo $fila['talla']==='XL' ?"selected='selected'" :""  ?> values="XL">XL</option>
                                                <option <?php echo $fila['talla']==='TALLA UNICA' ?"selected='selected'" :""  ?> values="TALLA UNICA">TALLA UNICA</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- <div class="card w-100 mt-5">
